...
$(document).ready(function () {     /*ready*/
                ...
                //});
                if (winWidthFirst >= 430) {  /*窗口宽度大于400,仅仅是刚开始一打开页面的时候检测到窗口大小并随之反应*/
                    ...
                    $("#top-search").focus(function () {    /*鼠标点击搜索框*/
                        $("#top-search").css({ "width": ((winWidthFirst - 155) * 0.5) });
                            $(window).resize(function () {  /*先点击后检测*/
                                winWidth = $(window).width();
                        ...
                        //    else if (0< winWidth < 430) {/*总是有问题，无奈阿西吧*/
                    ...
                    $("#top-search").blur(function () {   /*鼠标不落在搜索框,小于430px 的情况没写*/
                        $("#top-search").css({ "width": "120px" });
                    });
                    $("#top-search").keydown(function (event) {     /*要在按到搜索框的时候才检测回车键时候搜索，电脑上可用，手机端可用*/
                        if (event.which == "13")
                            search();
                    });
                ...
                else if (0 < winWidthFirst < 430) {     /*窗口宽度小于400,仅仅是刚开始一打开页面的时候检测到窗口大小并随之反应*/
                    $("#logo-wrapper").css({ "width": "100px", "height": "24px" ,"margin":"30px 0"});
                    $("#top-search").css({ "width": "89px" });
                    $("#top-search").focus(function () {    /*鼠标点击搜索框*/
                        $("#top-search").css({ "width": "89px" });
                    ...
                    $("#top-search").blur(function () {   /*鼠标不落在搜索框，小于430px 情况没写有问题*/
                        $(window).resize(function () {
                            winWidth2 = $(window).width();
                            if (winWidth2 >= 430) {
                                $("#top-search").css({ "width": "120px" });
                            }
                            else if (0 < winWidth2 < 430) {
                                $("#top-search").css({ "width": "89px" });
                            }
                        });
                    });
